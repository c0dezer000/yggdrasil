...
- [[seed/protocols/loop]] — loop protocol (plan â†’ execute â†’ validate cycle)
...
- [[seed/memory/knowledge-index]] — this file, topic-to-file mapping
- [[seed/memory/distilled-local]] — compressed memory profile for local tier (â‰¤2K tokens)
...
- [[deliberation/harness-decision/memo]] — Â§6 mandatory stop
